...
# 新增t-SNE相关导入
import matplotlib
matplotlib.use('Agg')  # Linux / 服务器必需，避免图形界面报错
...
from Compare_config.arguments_3DSS import get_parser
...
from Com_3DSS.videomamba import VisionMamba

# 新增t-SNE保存函数，和原代码保持一致
