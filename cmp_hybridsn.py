...
from Compare_config.arguments_hybridsn import get_parser
...
get_dataset_name = args.get_dataset_name
device = args.device
...
if __name__ == '__main__':
    ...
    # if get_dataset_name == 'ip':
    data = applyPCA(data,30)  # ip
    # else:
        # data = applyPCA(data, 15)
    ...
    for exp_idx,curr_seed in enumerate(seed_list):
        ...
        # build Model
        net = get_model("hybridsn",get_dataset_name,value)
        net.to(device)
        ...
        best_net  = get_model("hybridsn",get_dataset_name,value)
