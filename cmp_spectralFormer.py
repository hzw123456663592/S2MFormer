...
from Compare_config.arguments_spectralformer import get_parser
...
if __name__ == '__main__':
    ...
    for exp_idx,curr_seed in enumerate(seed_list):
        ...
        net = get_model("spectralformer",get_dataset_name,value)
        net.to(device)
        ...
        if record_computecost:
            ...
            input_shape = (1,  channels, value, value)  # 1输入形状
        ...
        # best_net = MambaHSI(in_channels=channels,num_classes=class_count,hidden_dim=128,mamba_type=mamba_type)
        best_net = get_model("spectralformer",get_dataset_name,value)
