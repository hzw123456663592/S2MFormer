...
def ssftt(dataset, patch_size):
    ...
    if dataset == 'sa':
        ...
        model = SSFTTnet(n_bands=274, num_classes=16)  # 常见版本270波段，16类
    elif dataset == 'houston2013':
        model = SSFTTnet(n_bands=144, num_classes=15)  # 144波段（含Lidar或仅HSI），15类
    elif dataset == 'whulk':
        ...
        model = SSFTTnet(n_bands=270, num_classes=29)  # 128波段，29类（根据常用版本）
...
#     # t = torch.randn(size=(64, 1, 200, 13,13))
#     t = torch.randn(size=(64, 1, 274, 13,13))
#
#     print("input shape:", t.shape)
#     net = ssftt(dataset='hanchuan', patch_size=13)
