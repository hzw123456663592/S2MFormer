...
def get_model(model_name, dataset_name, patch_size):
    if model_name == 'cnn2d':
        ...
        model = morphFormer(16, 80, 16, False, patch_size) # ip hanchuan
        # model = morphFormer(16, 80, 9, False, patch_size) # pu
        # model = morphFormer(16, 80, 15, False, patch_size) # houston
