...
from Compare_config.arguments_MambaLG import get_parser
from utils.setup_logger import setup_logger
from utils.seed import setup_seed
from utils.vis_a_img import vis_a_image
# from mambaLG.mambaLG_IP import mambaLG
from mambaLG.mambaLG import mambaLG
...
if __name__ == '__main__':
    ...
    for exp_idx,curr_seed in enumerate(seed_list):
        ...
        #     heads=heads,
        #     use_att=use_att)
        net = mambaLG(num_classes=class_count,dim = 64,band=channels,device=device,spec_num=12,spec_rate=0.5,spa_token=12)
        net.to(device)
        ...
        #                     heads=heads,
        #                     use_att=use_att)
        best_net = mambaLG(num_classes=class_count,dim = 64,band=channels,device=device,spec_num=12,spec_rate=0.5,spa_token=12)
